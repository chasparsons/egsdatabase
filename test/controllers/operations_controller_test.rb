...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post operations_url, params: { operation: { or_date: @operation.or_date, patient_id: @operation.patient_id, surgeon_id: @operation.surgeon_id } }
    end
  ...
  test "should update operation" do
    patch operation_url(@operation), params: { operation: { or_date: @operation.or_date, patient_id: @operation.patient_id, surgeon_id: @operation.surgeon_id } }
