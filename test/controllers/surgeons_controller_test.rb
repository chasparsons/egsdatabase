...
class SurgeonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create surgeon" do
    assert_difference('Surgeon.count') do
      post surgeons_url, params: { surgeon: { email: @surgeon.email, firstname: @surgeon.firstname, lastname: @surgeon.lastname } }
    end
  ...
  test "should update surgeon" do
    patch surgeon_url(@surgeon), params: { surgeon: { email: @surgeon.email, firstname: @surgeon.firstname, lastname: @surgeon.lastname } }
